...
public class Cliente extends Usuario {
    ...
    public Cliente (String nombre, String apellido, String telefono, String fechaDeNacimiento, String nombreUsuario, String contrasena) {
        super(nombre, apellido, telefono,fechaDeNacimiento, Rol.CLIENTE, nombreUsuario, contrasena);
